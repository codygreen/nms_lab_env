...
runcmd:
  ...
  - printf "deb [signed-by=/usr/share/keyrings/nginx-archive-keyring.gpg] https://pkgs.nginx.com/plus/R27/ubuntu `lsb_release -cs` nginx-plus\n" | sudo tee /etc/apt/sources.list.d/nginx-plus.list
  - printf "deb [signed-by=/usr/share/keyrings/nginx-archive-keyring.gpg] https://pkgs.nginx.com/app-protect/R27/ubuntu `lsb_release -cs` nginx-plus\n" | sudo tee /etc/apt/sources.list.d/nginx-app-protect.list
  ...
  - apt-get update && apt-get install -y app-protect-compiler=10.139.2-1~focal app-protect-plugin=3.1088.2-1~focal nginx-plus-module-appprotect=27+3.1088.2-1~focal app-protect-engine=10.139.2-1~focal app-protect=27+3.1088.2-1~focal nginx-plus-module-njs
